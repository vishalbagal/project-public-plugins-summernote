      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          click: function click(event) {
            ...
            //Start Custom Code By Vikas
            if($('.abtHolder').is(":visible")){
              var $parent = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('.abtHolder').find('.' + className).find('.note-dropdown-menu');
            }
            else if ($('.msoaHolder').is(":visible")){
              var $parent = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('.msoaHolder').find('.' + className).find('.note-dropdown-menu');
            }
            else if ($('.mepyHolder').is(":visible")){
              var $parent = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('.mepyHolder').find('.' + className).find('.note-dropdown-menu');
            }
            else{
              var $parent = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('.mepvHolder').find('.' + className).find('.note-dropdown-menu');
            }
            //End Custom Code By Vikas
